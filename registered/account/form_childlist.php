...
<div class="row mt-5">
  ...
  <div class="col-4 text-right">
    <h3><a href="addparentchild.php" class="btn disabled"><span class="fas fa-plus btn btn-primary"></span></a></h3>
  </div>
</div>
...
<?php
    ...
    foreach($children as $child) { ?>
      <tr>
        ...
        <td class="text-center"><a href="<?php echo '../swimmer/show.php?id=' . h(u($child->id)); ?>"><span class="fas fa-eye"></span></a></td>
      </tr>
      <?php } ?>
